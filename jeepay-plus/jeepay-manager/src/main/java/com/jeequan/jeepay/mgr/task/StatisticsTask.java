...
public class StatisticsTask {
    ...
    public boolean canExecuteTask() {
        LocalTime startTime = LocalTime.of(0, 0, 30); // 00:01:00
        LocalTime endTime = LocalTime.of(23, 59, 30); // 23:59:00

        LocalTime currentTime = LocalTime.now();
        boolean isWithinRange = isTimeWithinRange(currentTime, startTime, endTime);
        if (!isWithinRange) {
            log.info("日切时间停止成功订单异步计算");
        }
    ...
    public void test() {
        ...
        payOrder1.setPayOrderId("T1");
        payOrder1.setAmount(10000L);
        payOrder1.setState(PayOrder.STATE_ING);
        payOrder1.setProductId(1000L);
        payOrder1.setPassageId(1008L);
        payOrder1.setMchNo("M1691334867");
        payOrder1.setMchFeeAmount(1000L);
        payOrder1.setPassageFeeAmount(500L);
        payOrder1.setAgentFeeAmount(0L);
        payOrder1.setAgentPassageFee(0L);
        payOrder1.setCreatedAt(DateUtil.parse("2023-08-16 23:45:12", "yyyy-MM-dd HH:mm:ss"));

        PayOrder payOrder2 = new PayOrder();
        payOrder2.setPayOrderId("T1");
        payOrder2.setAmount(10000L);
        payOrder2.setState(PayOrder.STATE_ING);
        payOrder2.setProductId(1000L);
        payOrder2.setPassageId(1008L);
        payOrder2.setMchNo("M1691231056");
        payOrder2.setMchFeeAmount(1000L);
        payOrder2.setPassageFeeAmount(500L);
        payOrder2.setAgentFeeAmount(0L);
        payOrder2.setAgentPassageFee(0L);
        payOrder2.setCreatedAt(DateUtil.parse("2023-08-15 23:52:15", "yyyy-MM-dd HH:mm:ss"));

//        PayOrder payOrder3 = new PayOrder();
//        payOrder3.setPayOrderId("T1");
//        payOrder3.setAmount(10000L);
//        payOrder3.setState(PayOrder.STATE_ING);
//        payOrder3.setProductId(1000L);
//        payOrder3.setPassageId(1008L);
//        payOrder3.setMchNo("M1691231056");
//        payOrder3.setMchFeeAmount(1000L);
//        payOrder3.setPassageFeeAmount(500L);
//        payOrder3.setAgentFeeAmount(0L);
//        payOrder3.setAgentPassageFee(0L);
//        payOrder3.setCreatedAt(DateUtil.parse("2023-08-16 00:51:26", "yyyy-MM-dd HH:mm:ss"));

        List<PayOrder> payOrderList = new ArrayList<>();
        payOrderList.add(payOrder1);
        payOrderList.add(payOrder2);
//        payOrderList.add(payOrder3);


        List<PayOrder> payOrderListSuccess = new ArrayList<>();
        PayOrder payOrder11 = new PayOrder();
        payOrder11.setPayOrderId("T1");
        payOrder11.setAmount(10000L);
        payOrder11.setProductId(1000L);
        payOrder11.setPassageId(1008L);
        payOrder11.setMchNo("M1691334867");
        payOrder11.setMchFeeAmount(1000L);
        payOrder11.setPassageFeeAmount(500L);
        payOrder11.setAgentFeeAmount(0L);
        payOrder11.setAgentPassageFee(0L);
        payOrder11.setCreatedAt(DateUtil.parse("2023-08-16 23:45:12", "yyyy-MM-dd HH:mm:ss"));
        payOrder11.setState(PayOrder.STATE_SUCCESS);
        payOrder11.setSuccessTime(DateUtil.parse("2023-08-16 01:06:09", "yyyy-MM-dd HH:mm:ss"));

        PayOrder payOrder22 = new PayOrder();
        payOrder22.setPayOrderId("T1");
        payOrder22.setAmount(10000L);
        payOrder22.setProductId(1000L);
        payOrder22.setPassageId(1008L);
        payOrder22.setMchNo("M1691231056");
        payOrder22.setMchFeeAmount(1000L);
        payOrder22.setPassageFeeAmount(500L);
        payOrder22.setAgentFeeAmount(0L);
        payOrder22.setAgentPassageFee(0L);
        payOrder22.setCreatedAt(DateUtil.parse("2023-08-15 23:52:15", "yyyy-MM-dd HH:mm:ss"));
        payOrder22.setState(PayOrder.STATE_SUCCESS);
        payOrder22.setSuccessTime(DateUtil.parse("2023-08-16 01:06:05", "yyyy-MM-dd HH:mm:ss"));


//        PayOrder payOrder33 = new PayOrder();
//        payOrder33.setPayOrderId("T1");
//        payOrder33.setAmount(10000L);
//        payOrder33.setProductId(1000L);
//        payOrder33.setPassageId(1008L);
//        payOrder33.setMchNo("M1691231056");
//        payOrder33.setMchFeeAmount(1000L);
//        payOrder33.setPassageFeeAmount(500L);
//        payOrder33.setAgentFeeAmount(0L);
//        payOrder33.setAgentPassageFee(0L);
//        payOrder33.setCreatedAt(DateUtil.parse("2023-08-16 00:51:26", "yyyy-MM-dd HH:mm:ss"));
//        payOrder33.setState(PayOrder.STATE_SUCCESS);
//        payOrder33.setSuccessTime(DateUtil.parse("2023-08-16 01:06:11", "yyyy-MM-dd HH:mm:ss"));

        payOrderListSuccess.add(payOrder11);
        payOrderListSuccess.add(payOrder22);
//        payOrderListSuccess.add(payOrder33);

        log.info("测试入库统计开始");
        UpdateRecord(payOrderList);
        UpdateSuccessRecord(payOrderListSuccess);
        log.info("测试入库统计结束");
    }
