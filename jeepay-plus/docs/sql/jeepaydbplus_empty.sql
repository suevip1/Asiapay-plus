...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代理商资金账户流水表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '分账记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商户资金账户流水表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `t_mch_info` VALUES ('M1691231056', '测试商户', 1, NULL, 100033, 801, '2023-08-05 18:24:16.000000', '2023-08-30 01:38:52.202484', 'XFjGbHNUho8MqYWycYsNFzSwBVvOAIepDz1QDTfoIfKFojXVyTFHReNteWzGSVoXyXLJzDAo9p0G6GIjQYPAPJXSttlymJ9pqvaVUsna8v6cRezJvmTSJleEPImlTqDI', NULL, '', 9230, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商户通知记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商户-通道关系表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商户-产品关系表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_mch_product
-- ----------------------------
INSERT INTO `t_mch_product` VALUES (1, 'M1691231056', 1000, 1, '2023-09-06 23:59:32.039396', '2023-09-06 23:59:36.423062', 0.100000, 0.000000);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通道余额调额记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_pay_interface_define` VALUES ('dafu', '大富支付', '[{\"desc\": \"商户号\", \"name\": \"mchNo\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"秘钥\", \"name\": \"secret\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"通道类型\", \"name\": \"payType\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"支付网关\", \"name\": \"payGateway\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"回调白名单(多个地址以 | 分隔，*表示允许全部IP)\", \"name\": \"whiteList\", \"type\": \"textarea\", \"verify\": \"required\"}]', '#E81F55', 1, NULL, '2023-08-30 01:13:06.567551', '2023-08-30 01:13:06.567551');
INSERT INTO `t_pay_interface_define` VALUES ('gawasy', 'Gawasy支付', '[{\"desc\": \"商户号\", \"name\": \"mchNo\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"秘钥\", \"name\": \"secret\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"通道编码\", \"name\": \"payType\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"支付网关\", \"name\": \"payGateway\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"回调白名单(多个地址以 | 分隔)，*表示允许全部IP\", \"name\": \"whiteList\", \"type\": \"textarea\", \"verify\": \"required\"}]', '#45CABB', 1, NULL, '2023-08-09 18:19:52.000000', '2023-08-09 18:19:52.000000');
...
INSERT INTO `t_pay_interface_define` VALUES ('kamipay', '大富卡密支付2', '[{\"desc\": \"商户号\", \"name\": \"mchNo\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"秘钥\", \"name\": \"secret\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"通道类型\", \"name\": \"payType\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"支付网关\", \"name\": \"payGateway\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"回调白名单(多个地址以 | 分隔，*表示允许全部IP)\", \"name\": \"whiteList\", \"type\": \"textarea\", \"verify\": \"required\"}]', '#DDB0D5', 1, NULL, '2023-08-24 20:02:46.000000', '2023-08-24 20:02:46.000000');
...
INSERT INTO `t_pay_interface_define` VALUES ('rixinpay', '日鑫支付', '[{\"desc\": \"商户号\", \"name\": \"mchNo\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"秘钥\", \"name\": \"secret\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"通道编码\", \"name\": \"payType\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"支付网关\", \"name\": \"payGateway\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"回调白名单(多个地址以 | 分隔)，*表示允许全部IP\", \"name\": \"whiteList\", \"type\": \"textarea\", \"verify\": \"required\"}]', '#0CC145', 1, NULL, '2023-08-06 16:33:51.000000', '2023-08-06 16:33:51.000000');
INSERT INTO `t_pay_interface_define` VALUES ('rixinpay2', '日鑫2接口', '[{\"desc\": \"商户号\", \"name\": \"mchNo\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"秘钥\", \"name\": \"secret\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"通道编码\", \"name\": \"payType\", \"type\": \"text\", \"verify\": \"required\"}, {\"desc\": \"支付网关\", \"name\": \"payGateway\", \"type\": \"textarea\", \"verify\": \"required\"}, {\"desc\": \"回调白名单(多个地址以 | 分隔)，*表示允许全部IP\", \"name\": \"whiteList\", \"type\": \"textarea\", \"verify\": \"required\"}]', '#7AE485', 1, NULL, '2023-08-27 21:36:34.000000', '2023-08-27 21:36:34.000000');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1009 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付通道表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `t_product` VALUES (1000, '测试产品', '2023-09-06 23:59:26.812081', '2023-09-06 23:59:26.802000', 0, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 151 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代理商日统计表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 230 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代理商-商户日统计表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 504 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代理商-通道日统计表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1238 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商户日统计表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4429 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商户-产品日统计表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3137 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付通道日统计表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 798 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付产品日统计表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `t_sys_config` VALUES ('agentSiteUrl', '代理商平台网址(不包含结尾/)', '代理商平台网址(不包含结尾/)', 'applicationConfig', '系统应用配置', 'http://127.0.0.1:9219', 'text', 4, '2023-09-07 00:01:00.314784');
INSERT INTO `t_sys_config` VALUES ('dataOffset', '数据清理设置(保留xx天的数据)', '数据清理设置(保留xx天的数据)', 'applicationConfig', '系统应用配置', '15', 'text', 5, '2023-08-31 01:04:08.091613');
INSERT INTO `t_sys_config` VALUES ('errorOrderWarnConfig', '异常订单预警 (0关闭，任意正数打开，如5)', '每分钟检测一次，异常订单数超过设置的数量时机器人发预警到管理群', 'robotsConfigGroup', '机器人配置', '5', 'text', 11, '2023-08-31 01:05:09.436373');
INSERT INTO `t_sys_config` VALUES ('forceOrderWarnConfig', '强制补单预警(0关闭，任意正数打开，如5)', '每分钟检测一次，强制补单数超过设置的数量时机器人发预警到管理群', 'robotsConfigGroup', '机器人配置', '5', 'text', 10, '2023-08-31 01:05:07.686355');
INSERT INTO `t_sys_config` VALUES ('loginWhiteList', '运营平台登录白名单(多个IP | 隔开,允许所有IP登录为*)', '运营平台登录白名单', 'applicationConfig', '系统应用配置', '*', 'textarea', 6, '2023-08-31 01:04:16.772490');
INSERT INTO `t_sys_config` VALUES ('mchSiteUrl', '商户平台网址(不包含结尾/)', '商户平台网址(不包含结尾/)', 'applicationConfig', '系统应用配置', 'http://127.0.0.1:9218', 'text', 3, '2023-09-07 00:01:00.323545');
INSERT INTO `t_sys_config` VALUES ('mgrSiteUrl', '运营平台网址(不包含结尾/)', '运营平台网址(不包含结尾/)', 'applicationConfig', '系统应用配置', 'http://127.0.0.1:9217', 'text', 2, '2023-09-07 00:01:00.318410');
INSERT INTO `t_sys_config` VALUES ('passageConfig', '通道配置预警(0关闭，1打开)', '三方通道商户信息被修改时机器人发预警到管理群', 'robotsConfigGroup', '机器人配置', '1', 'text', 12, '2023-08-31 01:05:11.357435');
INSERT INTO `t_sys_config` VALUES ('payPassageAutoClean', '通道余额过零点自动清零', '通道余额过零点自动清零', 'payConfigGroup', '支付配置', '1', 'text', 20, '2023-08-31 01:05:12.510238');
INSERT INTO `t_sys_config` VALUES ('paySiteUrl', '支付网关地址(不包含结尾/)', '支付网关地址(不包含结尾/)', 'applicationConfig', '系统应用配置', 'http://127.0.0.1:9216', 'text', 1, '2023-09-06 01:40:45.352373');
INSERT INTO `t_sys_config` VALUES ('platName', '平台名称', '平台名称', 'applicationConfig', '系统应用配置', '亚洲科技四方系统', 'text', 0, '2023-09-07 00:00:45.571051');
INSERT INTO `t_sys_config` VALUES ('robotsAdmin', '机器人管理员(飞机用户名)', '机器人管理员', 'robotsConfigGroup', '机器人配置', '', 'text', 7, '2023-09-07 00:00:28.374438');
INSERT INTO `t_sys_config` VALUES ('robotsToken', '机器人token(勿乱动，可能导致机器人失效)', '机器人token', 'robotsConfigGroup', '机器人配置', '', 'text', 8, '2023-09-07 00:00:28.379487');
INSERT INTO `t_sys_config` VALUES ('robotsUserName', '机器人用户名(勿乱动，可能导致机器人失效)', '机器人用户名(不带@)', 'robotsConfigGroup', '机器人配置', '', 'text', 9, '2023-09-07 00:00:28.377888');
...
) ENGINE = InnoDB AUTO_INCREMENT = 15563 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_sys_log
-- ----------------------------
INSERT INTO `t_sys_log` VALUES (15555, 'admin', '127.0.0.1', 'MGR', 'com.jeequan.jeepay.mgr.ctrl.payconfig.PayWayController.add', '新增支付方式', 'http://127.0.0.1:9217/api/payWays', '{\"productId\":\"1000\",\"productName\":\"测试产品\"}', '{\"msg\":\"SUCCESS\",\"code\":0}', '2023-09-06 23:59:26.816000');
INSERT INTO `t_sys_log` VALUES (15556, 'admin', '127.0.0.1', 'MGR', 'com.jeequan.jeepay.mgr.ctrl.payconfig.ProductMchController.blindAll', '产品-商户一键全绑定', 'http://127.0.0.1:9217/api/productMchInfo/blindAll/1000', '{}', '{\"msg\":\"SUCCESS\",\"code\":0}', '2023-09-06 23:59:32.040000');
INSERT INTO `t_sys_log` VALUES (15557, 'admin', '127.0.0.1', 'MGR', 'com.jeequan.jeepay.mgr.ctrl.payconfig.ProductMchController.update', '更新产品-商户绑定信息', 'http://127.0.0.1:9217/api/productMchInfo/', '{\"productId\":1000,\"mchRate\":0.1,\"state\":1,\"mchNo\":\"M1691231056\",\"agentRate\":0}', '{\"msg\":\"SUCCESS\",\"code\":0}', '2023-09-06 23:59:36.424000');
INSERT INTO `t_sys_log` VALUES (15558, 'admin', '127.0.0.1', 'MGR', 'com.jeequan.jeepay.mgr.ctrl.sysuser.SysUserController.add', '添加管理员', 'http://127.0.0.1:9217/api/sysUsers', '{\"loginUsername\":\"master\",\"isAdmin\":1,\"state\":1}', '{\"msg\":\"SUCCESS\",\"code\":0}', '2023-09-07 00:00:05.841000');
INSERT INTO `t_sys_log` VALUES (15559, 'master', '127.0.0.1', 'MGR', 'com.jeequan.jeepay.mgr.ctrl.anon.AuthController.validate', '登录认证', 'http://127.0.0.1:9217/api/anon/auth/validate', '{\"ip\":\"MTIzNDU2\",\"ia\":\"bWFzdGVy\",\"gc\":\"dW5kZWZpbmVk\",\"vc\":\"MTc2NA==\",\"vt\":\"MTgxMWJjZmYtMjdiOC00ODI1LWEzOWUtOGM4NzAxYTc3M2Ux\"}', '{\"msg\":\"SUCCESS\",\"code\":0,\"data\":{\"iToken\":\"eyJhbGciOiJIUzUxMiJ9.eyJjYWNoZUtleSI6IlRPS0VOXzEwMDEyOV83YTU0OTQ3OC0xZjliLTQwMmItYTk5YS01ZGU5MDFiMjhlYjkiLCJjcmVhdGVkIjoxNjk0MDE2MDE2MTQzLCJzeXNVc2VySWQiOjEwMDEyOX0.m09FeYtDpWTfVTK946JoShS0yLt2Yvv9-ebiioYirO5tKM0kM-S-DVLb1BdYfxQ_bKsVI5O1UvZksStrNshc4g\"}}', '2023-09-07 00:00:16.153000');
INSERT INTO `t_sys_log` VALUES (15560, 'master', '127.0.0.1', 'MGR', 'com.jeequan.jeepay.mgr.ctrl.config.SysConfigController.update', '系统配置修改', 'http://127.0.0.1:9217/api/sysConfigs/robotsConfigGroup', '{\"robotsAdmin\":\"\",\"errorOrderWarnConfig\":\"5\",\"robotsUserName\":\"\",\"robotsToken\":\"\",\"forceOrderWarnConfig\":\"5\",\"passageConfig\":\"1\"}', '{\"msg\":\"SUCCESS\",\"code\":0}', '2023-09-07 00:00:28.385000');
INSERT INTO `t_sys_log` VALUES (15561, 'master', '127.0.0.1', 'MGR', 'com.jeequan.jeepay.mgr.ctrl.config.SysConfigController.update', '系统配置修改', 'http://127.0.0.1:9217/api/sysConfigs/applicationConfig', '{\"paySiteUrl\":\"http://127.0.0.1:9216\",\"agentSiteUrl\":\"http://agent-api.eluosi-pay.com\",\"dataOffset\":\"15\",\"mgrSiteUrl\":\"http://mgr-api.eluosi-pay.com\",\"platName\":\"亚洲科技四方系统\",\"loginWhiteList\":\"*\",\"mchSiteUrl\":\"http://mch.eluosi-pay.com\"}', '{\"msg\":\"SUCCESS\",\"code\":0}', '2023-09-07 00:00:45.573000');
INSERT INTO `t_sys_log` VALUES (15562, 'master', '127.0.0.1', 'MGR', 'com.jeequan.jeepay.mgr.ctrl.config.SysConfigController.update', '系统配置修改', 'http://127.0.0.1:9217/api/sysConfigs/applicationConfig', '{\"paySiteUrl\":\"http://127.0.0.1:9216\",\"agentSiteUrl\":\"http://127.0.0.1:9219\",\"dataOffset\":\"15\",\"mgrSiteUrl\":\"http://127.0.0.1:9217\",\"platName\":\"亚洲科技四方系统\",\"loginWhiteList\":\"*\",\"mchSiteUrl\":\"http://127.0.0.1:9218\"}', '{\"msg\":\"SUCCESS\",\"code\":0}', '2023-09-07 00:01:00.323000');
...
) ENGINE = InnoDB AUTO_INCREMENT = 100130 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统用户表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_user` VALUES (100129, 'master', 1, 1, 'MGR', '0', '2023-09-07 00:00:05.760298', '2023-09-07 00:00:05.760298');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1132 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统用户认证表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_sys_user_auth
-- ----------------------------
INSERT INTO `t_sys_user_auth` VALUES (801, 801, 1, 'admin', '$2a$10$dZPFA7DYXWlYE3RBFr1zdu5c9vH1auaNtOxLqHUwoASPzgNM/1fBi', 'testkey', 'MGR', 0, 'MLC72VZKZRDOTCTM73TVGIN6F7FZOKPT');
...
INSERT INTO `t_sys_user_auth` VALUES (1131, 100129, 1, 'master', '$2a$10$9d8JVv/NHOqZKVSFyE5iPupItYcC7WQtUv8WuRRBMdzOhTZ3VMM6a', 'd1e833', 'MGR', 0, NULL);
