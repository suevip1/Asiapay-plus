...
public class MainGen {
    ...
    public static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/jeepaydbplus?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8";
    public static final String DB_USERNAME = "jeepaydbplus";
    public static final String DB_PASSWORD = "b6y2zKrs3sMdk6YMARwz";

    // 多个用,  拼接
    public static final String TABLE_NAMES= "t_error_order";
