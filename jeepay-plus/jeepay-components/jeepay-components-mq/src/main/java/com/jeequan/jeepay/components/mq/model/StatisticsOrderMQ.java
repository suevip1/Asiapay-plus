...
@NoArgsConstructor
@AllArgsConstructor
public class StatisticsOrderMQ extends AbstractMQ {

    /**
     * 【！重要配置项！】 定义MQ名称
     **/
    public static final String MQ_NAME = "STATISTICS_ORDER";
     ...
     **/
    public static StatisticsOrderMQ build(String payOrderId, PayOrder payOrder) {
        return new StatisticsOrderMQ(new MsgPayload(payOrderId, payOrder));
    }
