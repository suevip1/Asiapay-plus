...
@ConditionalOnBean(BalanceChangeMQ.IMQReceiver.class)
public class BalanceChangeActiveMQReceiver implements IMQMsgReceiver {

    @Autowired
    private BalanceChangeMQ.IMQReceiver mqReceiver;

    /** 接收 【 queue 】 类型的消息 **/
    @Override
    @Async(MqThreadExecutor.EXECUTOR_PAYORDER_MCH_NOTIFY)
    @JmsListener(destination = BalanceChangeMQ.MQ_NAME)
    public void receiveMsg(String msg){
        mqReceiver.receive(BalanceChangeMQ.parse(msg));
    }
