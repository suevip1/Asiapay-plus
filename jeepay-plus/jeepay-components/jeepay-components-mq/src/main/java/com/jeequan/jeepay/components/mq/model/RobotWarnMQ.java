...
@NoArgsConstructor
@AllArgsConstructor
public class RobotWarnMQ extends AbstractMQ {

    /**
     * 【！重要配置项！】 定义MQ名称
     **/
    public static final String MQ_NAME = "ROBOTS_WARN_MQ";
     ...
     **/
    public static RobotWarnMQ build(Byte warnType, String data) {
        return new RobotWarnMQ(new MsgPayload(warnType, data));
    }
