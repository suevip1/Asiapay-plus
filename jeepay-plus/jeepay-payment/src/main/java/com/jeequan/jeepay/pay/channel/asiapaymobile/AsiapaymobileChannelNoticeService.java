package com.jeequan.jeepay.pay.channel.asiapaymobile;
...
@Slf4j
@Service
public class AsiapaymobileChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "亚洲话费三方支付";
