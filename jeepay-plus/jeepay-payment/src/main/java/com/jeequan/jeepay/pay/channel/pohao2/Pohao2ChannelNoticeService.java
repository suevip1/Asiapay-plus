...
@Slf4j
@Service
public class Pohao2ChannelNoticeService extends AbstractChannelNoticeService {
    private static final String LOG_TAG = "[坡豪支付2]";

    private static final String ON_FAIL = "fail";

    private static final String ON_SUCCESS = "ces";
    ...
    public static void main(String[] args){
        String jsonParams = "{\"out_trade_no\":\"P1767806037021691905\",\"trade_status\":\"TRADE_SUCCESS\",\"name\":\"name\",\"sign\":\"8980be2fc773a05cd7c5468f9b234b06\",\"trade_no\":\"2024031314525818235\",\"pid\":\"1011\",\"type\":\"alipay\",\"sign_type\":\"MD5\"}";
        Map map = JSON.parseObject(jsonParams);
        String sign = map.get("sign").toString();
        log.info("返回Sign："+ sign);

        String secret = "RAfi3EYWF31azoW3gg";
        map.remove("sign");
        map.remove("sign_type");
