package com.jeequan.jeepay.pay.channel.rixinpay4;
...
@Service
@Slf4j
public class Rixinpay4PaymentService extends AbstractPaymentService {

    private static final String LOG_TAG = "[日鑫4支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.RIXINPAY4;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            if (result.getString("status").equals("1")) {
                ...
                String payUrl = result.getString("h5_url");
