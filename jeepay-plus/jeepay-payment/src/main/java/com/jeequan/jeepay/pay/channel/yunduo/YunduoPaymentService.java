package com.jeequan.jeepay.pay.channel.yunduo;
...
@Service
@Slf4j
public class YunduoPaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[YD支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.YUNDUO;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            if (result.getString("code").equals("1")) {
                ...
                String payUrl = result.getString("qrcode");
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "ctRVkaQuzqYra4Cg1a8BQ3TQ18KgC4qT";
        ...
        String payGateway = "https://p.francework.space/mapi.php";
