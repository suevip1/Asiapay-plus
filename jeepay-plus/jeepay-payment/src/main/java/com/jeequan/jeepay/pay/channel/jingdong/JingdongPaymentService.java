package com.jeequan.jeepay.pay.channel.jingdong;
...
@Service
@Slf4j
public class JingdongPaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[京东支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.JINGDONG;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String payMchId = normalMchParams.getMchNo();
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "JSQUVONSGHXYFQPFWQEEAKAZDSUTYUG8";

        String payMchId = "1177717256382054400";
        String mchOrderNo = RandomStringUtils.random(15, true, true);
        String productId = "1119";
        Long amount = 10000L;
        ...
        String payGateway = "http://110.42.1.248:9998/api/pay/createOrder";
