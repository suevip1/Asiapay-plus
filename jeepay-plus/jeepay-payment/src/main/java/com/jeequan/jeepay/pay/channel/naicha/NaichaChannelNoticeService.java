package com.jeequan.jeepay.pay.channel.naicha;
...
@Slf4j
@Service
public class NaichaChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[奶茶支付]";
