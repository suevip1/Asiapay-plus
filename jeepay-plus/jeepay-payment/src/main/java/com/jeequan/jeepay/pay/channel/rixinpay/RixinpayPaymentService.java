package com.jeequan.jeepay.pay.channel.rixinpay;
...
@Service
@Slf4j
public class RixinpayPaymentService extends AbstractPaymentService {

    private static final String LOG_TAG = "[日鑫支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.RIXINPAY;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            if (result.getString("status").equals("1")) {
                ...
                String passageOrderId = result.getString("mch_order_id");
