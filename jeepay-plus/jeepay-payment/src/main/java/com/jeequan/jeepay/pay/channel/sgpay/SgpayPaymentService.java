...
@Service
@Slf4j
public class SgpayPaymentService extends AbstractPaymentService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "abbb3d704ea2862608d5b469e0069864";

        String channelId = "QX999980";
        String mcOrderNum = RandomStringUtils.random(15, true, true);
        String merchantId = "19775407";
        ...
        String payGateway = "http://shopapi.sgxyzpay.com/api/order/create";
