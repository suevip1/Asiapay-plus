...
@Slf4j
@Service
public class JiedaChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            //订单状态：1,4 已支付，其他状态都是未成功
            int orderstatus = jsonParams.getIntValue("orderstatus");
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("partnerorderid");        // 商户订单号
        String txnAmt = jsonParams.getString("payamount");        // 支付金额
