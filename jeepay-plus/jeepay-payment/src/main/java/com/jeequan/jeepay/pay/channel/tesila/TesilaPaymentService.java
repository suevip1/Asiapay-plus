...
@Service
@Slf4j
public class TesilaPaymentService extends AbstractPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            if (result.getString("status").equals("1")) {
                ...
                String payUrl = result.getString("payment_url");
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "tvdtl5anynvf1t8zr4l6le2w0134gz28";

        String pay_memberid = "10594";
        String pay_orderid = RandomStringUtils.random(15, true, true);
        String pay_applydate = DateUtil.now();
        String pay_bankcode = "934";
        ...
        String payGateway = "http://pay.teslaweb.cc/Pay_Index.html";
