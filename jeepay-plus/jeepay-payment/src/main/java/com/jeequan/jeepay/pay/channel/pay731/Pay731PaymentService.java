...
public class Pay731PaymentService extends AbstractPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String merchantNum = normalMchParams.getMchNo();
            ...
            String signStr = merchantNum + orderNo + amount + notifyUrl + key;
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "f7222636c14fdbf5a456225a5f5c2d17";

        String merchantNum = "俄罗斯";
