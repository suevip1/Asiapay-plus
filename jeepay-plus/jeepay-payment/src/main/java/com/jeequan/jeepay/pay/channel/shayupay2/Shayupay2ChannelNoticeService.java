package com.jeequan.jeepay.pay.channel.shayupay2;
...
@Slf4j
@Service
public class Shayupay2ChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[鲨鱼支付2]";
