package com.jeequan.jeepay.pay.channel.bypay;
...
@Service
@Slf4j
public class BypayPaymentService extends AbstractPaymentService {

    private static final String LOG_TAG = "[BY支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.BYPAY;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            //拉起订单成功
            if (result.getString("returncode").equals("00")) {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "a3g9ectjrni0zns36zstheovx2q7fpgd";

        String pay_memberid = "230400428";
        String pay_orderid = RandomStringUtils.random(15, true, true);
        String pay_applydate = DateUtil.now();
        String pay_bankcode = "944";
        ...
        String payGateway = "http://207.148.65.189/Pay_Index.html";
