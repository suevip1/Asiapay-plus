...
@Service
@Slf4j
public class ApplePaymentService extends AbstractPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String woshuo_niting = getNotifyUrl(payOrder.getPayOrderId());

            map.put("api_id", api_id);
            map.put("orderid", orderid);
            map.put("money", money);
            map.put("woshuo_niting", woshuo_niting);
    ...
    public static void main(String[] args) {
        String raw = "";
        Map<String, Object> map = new HashMap<>();
        String key = "fgmisdndg48s15dfse15sd97ge1x";

        String api_id = "p94542184156141";
        String orderid = RandomStringUtils.random(15, true, true);
        String money = AmountUtil.convertCent2Dollar(5000L);
        String woshuo_niting = "https://www.test.com";
        ...
        String payGateway = "http://8.217.240.162/apple/apple_sifang.php";
