package com.jeequan.jeepay.pay.channel.ganpay;
...
@Service
@Slf4j
public class GanpayPaymentService extends AbstractPaymentService {

    private static final String LOG_TAG = "淦pay支付";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.GANPAY;
    }
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "0caec82664cf11eeba2100163e025933";

        String appid = "JY-M005b9fb38d25c4a7";
        String amount = AmountUtil.convertCent2Dollar(10000L);
        String channel_code = "cmcc_k_alipay_H5_double";
        ...
        String payGateway = "http://39.108.86.196:8090/merchant/order";
