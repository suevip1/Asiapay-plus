...
@Slf4j
@Service
public class TianyangChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public static void main(String[] args) {
        String testStr = "{\n" +
                ...
                "    \"amount\": \"10000\",\n" +
                "    \"merchantId\": \"20000096\",\n" +
                "    \"orderId\": \"Z012024012913132332085450\",\n" +
                "    \"outTradeNo\": \"P1751835910417739778\",\n" +
                "    \"extra\": \"\",\n" +
                "    \"sign\": \"1A088E29ED9B3BF0F951F65C5A87C59F\",\n" +
                "    \"state\": \"success\",\n" +
                "    \"ts\": \"1706505441399\"\n" +
                "}";
        ...
        String secret = "0EF3FAD17375EA715B3F514309BDF4A1";



        String contentStr = SignatureUtils.getSignContentFilterEmpty(map, new String[]{""}) + "&key=" + secret;
        log.info(contentStr);
        String signStr = SignatureUtils.md5(contentStr).toUpperCase();
