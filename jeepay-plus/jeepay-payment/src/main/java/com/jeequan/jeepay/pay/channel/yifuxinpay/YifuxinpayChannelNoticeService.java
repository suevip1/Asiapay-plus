package com.jeequan.jeepay.pay.channel.yifuxinpay;
...
@Slf4j
@Service
public class YifuxinpayChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "新亿付支付";
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            int status = jsonParams.getInteger("order_status");
...
//        String orderNo = jsonParams.getString("mchOrderNo");
//        String txnAmt = jsonParams.getString("amount");
...
//        BigDecimal orderAmount = new BigDecimal(payOrder.getAmount());
        ...
        String sign = jsonParams.getString("md5_sign");
        ...
        if (resultsParam != null) {
            ...
            String signContent = SignatureUtils.getSignContent(map, null, null) + "&app_secret=" + secret;
