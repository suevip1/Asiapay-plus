package com.jeequan.jeepay.pay.channel.caicai;
...
@Service
@Slf4j
public class CaicaiPaymentService extends AbstractPaymentService {

    private static final String LOG_TAG = "[菜彩支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.CAICAI;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            if (result.getString("status").equals("success")) {
                ...
                String payUrl = result.getString("qrcode_url");
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "o2wlw9vpymsup4hl1skl3g1r1bpdh1c1";

        String pay_memberid = "231270794";
        String pay_orderid = RandomStringUtils.random(15, true, true);
        String pay_applydate = DateUtil.now();
        String pay_bankcode = "965";
        String pay_notifyurl = "https://www.test.com";
        String pay_callbackurl = pay_notifyurl;
        String pay_amount = AmountUtil.convertCent2Dollar(900L);
        ...
        String payGateway = "http://ccpay.xyanyun.cn/Pay_Index.html";
