package com.jeequan.jeepay.pay.channel.xiazi;
...
@Slf4j
@Service
public class XiaziChannelNoticeService extends AbstractChannelNoticeService {
    private static final String LOG_TAG = "[瞎子支付]";
