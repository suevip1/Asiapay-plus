...
@Slf4j
@Service
public class MayiChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        if (resultsParam != null) {
            ...
            final String signContentStr = SignatureUtils.getSignContent(map);
            final String signStr = SignatureUtils.md5(signContentStr + secret).toLowerCase();
