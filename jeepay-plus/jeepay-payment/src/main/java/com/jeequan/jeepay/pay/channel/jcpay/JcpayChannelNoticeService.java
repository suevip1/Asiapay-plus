package com.jeequan.jeepay.pay.channel.jcpay;
...
@Slf4j
@Service
public class JcpayChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[JC支付]";
