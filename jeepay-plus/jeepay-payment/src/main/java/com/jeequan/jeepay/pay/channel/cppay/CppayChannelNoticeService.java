...
@Slf4j
@Service
public class CppayChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("reqid");        // 商户订单号
        ...
        String merid = jsonParams.getString("merid");
        String reqid = jsonParams.getString("reqid");
        String payid = jsonParams.getString("payid");
        ...
        if (resultsParam != null) {
            ...
            final String signContentStr = merid + reqid + payid + money + status + secret;
