...
@Slf4j
@Service
public class ZhifupayChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            //code 交易结果 1（成功）
            int status = jsonParams.getInteger("code");
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        BigDecimal channelNotifyAmount = new BigDecimal(Double.parseDouble(txnAmt) * 100f);
        ...
        String pay_type = jsonParams.getString("pay_type");
        ...
        if (resultsParam != null) {
            ...
            final String signContentStr = order_no + merchant_no + out_order_no + amount + pay_type + code + secret;
