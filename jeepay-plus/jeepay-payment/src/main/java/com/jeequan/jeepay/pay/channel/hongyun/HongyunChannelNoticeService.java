...
@Slf4j
@Service
public class HongyunChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[鸿运支付]";

    private static final String ON_FAIL = "fail";

    private static final String ON_SUCCESS = "rs:{\"msg\":\"\",\"code\":\"200\"}";
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            int status = jsonParams.getInteger("payStatus");
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("thirdOrderNo");        // 商户订单号
        ...
        String sign = jsonParams.getString("_sign");
