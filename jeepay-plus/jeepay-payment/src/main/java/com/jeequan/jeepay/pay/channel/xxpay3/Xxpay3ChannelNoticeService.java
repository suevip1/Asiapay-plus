package com.jeequan.jeepay.pay.channel.xxpay3;
...
@Slf4j
@Service
public class Xxpay3ChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[xxpay3支付]";
