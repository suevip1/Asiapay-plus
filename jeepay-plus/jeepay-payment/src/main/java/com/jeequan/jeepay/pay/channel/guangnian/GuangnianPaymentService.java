package com.jeequan.jeepay.pay.channel.guangnian;
...
@Service
@Slf4j
public class GuangnianPaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[光年支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.GUANGNIAN;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String merchantOrderId = payOrder.getPayOrderId();
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "867e0bd5eedf499ca7b92fa7ecea5069";

        String mchId = "67-372";
        String productCode = "JDEK";
        String merchantOrderId = RandomStringUtils.random(15, true, true);
        ...
        String payGateway = "http://38.181.20.189:8085/paymentOrder/create";
