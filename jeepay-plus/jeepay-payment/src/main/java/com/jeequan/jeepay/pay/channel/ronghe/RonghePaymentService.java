...
public class RonghePaymentService extends AbstractPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String outTradeId = payOrder.getPayOrderId();
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "23478190c0b045aeaa8f475fa735194c ";

        String outTradeId = RandomStringUtils.random(15, true, true);
        String amount = AmountUtil.convertCent2Dollar(5000L);
        String productCode = "8888";
        String merchantId = "20240228001";
        String ip = "127.0.0.1";
        ...
        String payGateway = "http://pay-js.txpay.me/api/order/create";
