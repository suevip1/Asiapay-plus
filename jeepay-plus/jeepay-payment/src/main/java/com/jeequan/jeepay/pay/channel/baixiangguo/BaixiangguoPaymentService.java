package com.jeequan.jeepay.pay.channel.baixiangguo;
...
@Service
@Slf4j
public class BaixiangguoPaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[BXG支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.BAIXIANGGUO;
    }
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "1lcdv423bt62fe6gn1obklr683c433kl";

        String pay_memberid = "220707075";
        String pay_orderid = RandomStringUtils.random(15, true, true);
        String pay_applydate = DateUtil.now();
        String pay_bankcode = "8017";
        ...
        String payGateway = "http://61.4.118.237:8899/Pay_Index.html";
