...
@Slf4j
@Service
public class DealpayChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        String orderNo = jsonParams.getString("apporderid");        // 商户订单号
        ...
        if (resultsParam != null) {
            ...
            String signContentStr = SignatureUtils.getSignContentFilterEmpty(map, null) + secret;
