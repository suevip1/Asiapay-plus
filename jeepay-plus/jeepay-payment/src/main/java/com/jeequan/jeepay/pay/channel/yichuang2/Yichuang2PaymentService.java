package com.jeequan.jeepay.pay.channel.yichuang2;
...
@Service
@Slf4j
public class Yichuang2PaymentService extends AbstractPaymentService {

    private static final String LOG_TAG = "[艺创支付2]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.YICHUANG2;
    }
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "fexpr9b9ht441sc1fiq1p4e7of9hbwht";

        String pay_memberid = "10020";
        String pay_orderid = RandomStringUtils.random(15, true, true);

        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMddHHmmss");
        String pay_applydate = dateFormat.format(new Date());
        String pay_bankcode = "14";
        ...
        String payGateway = "http://dongfeng.lijian.email/Pay_Index.html";
