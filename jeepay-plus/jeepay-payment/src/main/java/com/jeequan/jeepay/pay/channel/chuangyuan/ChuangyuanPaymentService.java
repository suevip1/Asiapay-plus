package com.jeequan.jeepay.pay.channel.chuangyuan;
...
@Service
@Slf4j
public class ChuangyuanPaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[创远支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.CHUANGYUAN;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String pay_isjson = "1";
            String pay_clientip = payOrder.getClientIp();
            ...
            map.put("pay_isjson", pay_isjson);
            map.put("pay_clientip", pay_clientip);
    ...
    public static void main(String[] args) {
        ...
        String payGateway = "http://gateway.chuangyuanpay.com/api/payment";
