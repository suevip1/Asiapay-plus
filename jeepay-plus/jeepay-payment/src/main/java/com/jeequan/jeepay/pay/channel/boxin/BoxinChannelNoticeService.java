...
@Slf4j
@Service
public class BoxinChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            //1: 未支付 2: 已支付 3: 支付失败
            String status = jsonParams.getString("p4_status");
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("p1_merchantno");        // 商户订单号
        String txnAmt = jsonParams.getString("p2_amount");        // 支付金额
