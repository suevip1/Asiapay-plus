...
@Service
@Slf4j
public class Xiaobawang2PaymentService extends AbstractPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String signStr = SignatureUtils.getSignContentFilterEmpty(map, null) + "&keyvalue=" + key;
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "862BD6D3E956CF09F399F256964D01A7";
        ...
        String payGateway = "https://api.wopsdw.com/v1/payment";
