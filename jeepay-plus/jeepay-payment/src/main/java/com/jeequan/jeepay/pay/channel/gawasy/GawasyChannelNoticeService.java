...
@Slf4j
@Service
public class GawasyChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        if (resultsParam != null) {
            ...
            String signStr = SignatureUtils.md5(SignatureUtils.md5(SignatureUtils.md5(signContent))).toUpperCase();
