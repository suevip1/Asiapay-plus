...
@Slf4j
@Service
public class YaoguaiChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("traceno");        // 商户订单号
        ...
        if (resultsParam != null) {
            ...
            String signStr = SignatureUtils.md5(SignatureUtils.md5(signContentStr)).toUpperCase();
