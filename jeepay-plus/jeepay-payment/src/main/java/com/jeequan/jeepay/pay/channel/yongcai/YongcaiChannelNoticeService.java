package com.jeequan.jeepay.pay.channel.yongcai;
...
@Slf4j
@Service
public class YongcaiChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[永财支付]";
