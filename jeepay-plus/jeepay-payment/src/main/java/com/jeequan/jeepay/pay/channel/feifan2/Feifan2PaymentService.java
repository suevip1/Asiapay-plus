package com.jeequan.jeepay.pay.channel.feifan2;
...
public class Feifan2PaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[霏凡2支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.FEIFAN2;
    }
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "LhxUzqBdHlvEQwptCgPWnORkmIbiKTfu";

        String merId = "20240147";
        String orderId = RandomStringUtils.random(15, true, true);
        String orderAmt = AmountUtil.convertCent2Dollar(10000L);
        String channel = "7001";
        String desc = "desc";
        String ip = getRandomIpAddress();
        ...
        String payGateway = "http://185.189.243.105:35668/api/pay";
