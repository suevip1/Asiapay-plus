package com.jeequan.jeepay.pay.channel.pohao3;
...
@Service
@Slf4j
public class Pohao3PaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[坡豪支付3]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.POHAO3;
    }
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "qB2e2s32577GUUSrzcUUVQbeBs3JEzru";
        ...
        String payGateway = "http://agdx.vv44.cn.cname1415.yjs-cdn.com/mapi.php";
