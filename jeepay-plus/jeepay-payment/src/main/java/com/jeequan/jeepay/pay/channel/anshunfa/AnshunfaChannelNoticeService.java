...
@Slf4j
@Service
public class AnshunfaChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            //支付状态：1-【正常通知】  4-【订单补单】
            int orderStatus = jsonParams.getInteger("orderStatus");
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        String txnAmt = jsonParams.getString("paidFee");        // 支付金额
        ...
        map.remove("sign");
        if (anshunfaParamsModel != null) {
            String secret = anshunfaParamsModel.getSecret();
