...
@Slf4j
@Service
public class YichuangChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            //支付状态：1=支付成功 5=驳回
            String returncode = jsonParams.getString("status");
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        BigDecimal orderAmount = new BigDecimal(AmountUtil.convertCent2Dollar(payOrder.getAmount().toString()));
