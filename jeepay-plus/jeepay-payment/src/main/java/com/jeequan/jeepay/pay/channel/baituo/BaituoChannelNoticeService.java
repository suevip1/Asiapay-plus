...
@Slf4j
@Service
public class BaituoChannelNoticeService extends AbstractChannelNoticeService {
    private static final String LOG_TAG = "[拜托支付]";

    private static final String ON_FAIL = "fail";

    private static final String ON_SUCCESS = "{\"code\": 1, \"msg\": \"\"}";
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        if (resultsParam != null) {
            ...
            final String signContentStr = SignatureUtils.getSignContentFilterEmpty(map, new String[]{"attach"});
            final String signContentStr2 = timestamp + secret + signContentStr;
            final String signStr = SignatureUtils.md5(signContentStr2).toUpperCase();
    ...
    public static void main(String[] args) {
        String timestamp = "1709992924";
        String str = "{\"amount\":\"100.00\",\"orderno\":\"P1766477005830279169\",\"sign\":\"0287DA1B53BE658BB029D89C0E51C516\",\"plat\":\"keepay\",\"timestamp\":\"1709996358\",\"status\":\"5\"}";
        ...
        map.remove("plat");
        map.remove("timestamp");
        String secret = "8308df94de1311ee865900163e01a9ee";
        final String signContentStr = SignatureUtils.getSignContentFilterEmpty(map, new String[]{"attach"});
        log.info("signContentStr：{}", signContentStr);
        final String signContentStr2 = timestamp + secret + signContentStr;
        log.info("signContentStr2：{}", signContentStr2);
        final String signStr = SignatureUtils.md5(signContentStr2).toUpperCase();
        log.info("校验结果：{}", signStr);
    }
}
