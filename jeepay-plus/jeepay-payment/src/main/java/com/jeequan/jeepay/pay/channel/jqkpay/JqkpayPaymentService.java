...
@Service
@Slf4j
public class JqkpayPaymentService extends AbstractPaymentService {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "W80msPjEwY9j5Hj1YxI2bMRg8ig1vOfp";
        ...
        String payGateway = "https://api.jqkpay.top/order/create";
