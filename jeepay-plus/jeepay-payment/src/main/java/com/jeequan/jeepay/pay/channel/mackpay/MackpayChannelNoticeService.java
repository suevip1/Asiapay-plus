package com.jeequan.jeepay.pay.channel.mackpay;
...
@Slf4j
@Service
public class MackpayChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[MackPay支付]";
