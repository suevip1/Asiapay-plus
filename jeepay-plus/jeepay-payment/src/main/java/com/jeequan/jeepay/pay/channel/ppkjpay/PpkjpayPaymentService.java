package com.jeequan.jeepay.pay.channel.ppkjpay;
...
@Service
@Slf4j
public class PpkjpayPaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[PP科技支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.PPKJPAY;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String service = normalMchParams.getPayType();
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "b568bbcea038480e9500ccb4eef74ef9";

        String mch_id = "M259IHFHMO";
        String service = "608";
        String out_trade_no = RandomStringUtils.random(15, true, true);
        String total_fee = "10000";
        String body = "body";
        ...
        String payGateway = "https://api.pppay.top/gateway/payment";
