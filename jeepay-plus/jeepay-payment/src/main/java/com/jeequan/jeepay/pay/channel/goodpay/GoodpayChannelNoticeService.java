...
@Slf4j
@Service
public class GoodpayChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            String status = jsonParams.getString("trade_status");
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("order_id");        // 商户订单号
        ...
        // 回调签名参数为五个，notify_url，order_id，order_amount，return_url，pay_type 将这5个参数按字典序排序参数
        Map<String, Object> signMap = new HashMap<>();
        signMap.put("notify_url", map.get("notify_url"));
        signMap.put("order_id", map.get("order_id"));
        signMap.put("order_amount", map.get("order_amount"));
        signMap.put("return_url", map.get("return_url"));
        signMap.put("pay_type", map.get("pay_type"));
