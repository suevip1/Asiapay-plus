...
@Service
@Slf4j
public class XiaosanPaymentService extends AbstractPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String mer_no = normalMchParams.getMchNo();
            ...
            if (result.getString("code").equals("1")) {
                ...
                String passageOrderId = data.getString("out_trade_no");
    ...
    public static void main(String[] args) {
        ...
        String payGateway = "http://zy.kowsaws.xyz/api/gateway/suborder";
