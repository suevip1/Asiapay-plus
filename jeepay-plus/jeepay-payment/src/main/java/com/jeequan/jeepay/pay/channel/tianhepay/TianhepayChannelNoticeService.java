...
@Slf4j
@Service
public class TianhepayChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        BigDecimal orderAmount = new BigDecimal(payOrder.getAmount() / 100);
        ...
        if (resultsParam != null) {
            ...
            final String signContentStr = SignatureUtils.getSignContentFilterEmpty(map, null) + "&md5key=" + secret;
