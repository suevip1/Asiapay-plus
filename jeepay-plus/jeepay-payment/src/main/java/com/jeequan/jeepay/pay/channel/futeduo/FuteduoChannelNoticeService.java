...
@Slf4j
@Service
public class FuteduoChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            if (status != 1) {
                ...
                result.setChannelOrderId(jsonParams.getString("up_order_no"));
            } else {
                //验签成功后判断上游订单状态
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        if (resultsParam != null) {
            ...
            String signContentStr = SignatureUtils.getSignContent(map, "", "", null, null, false) + secret;
