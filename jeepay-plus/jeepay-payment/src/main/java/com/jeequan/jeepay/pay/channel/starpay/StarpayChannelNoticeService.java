package com.jeequan.jeepay.pay.channel.starpay;
...
@Slf4j
@Service
public class StarpayChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[星星支付]";
    ...
    public MutablePair<String, Object> parseParams(HttpServletRequest request, String urlOrderId, NoticeTypeEnum noticeTypeEnum) {
        try {
            ...
            return MutablePair.of(params.getString("mchOrderNo"), params);
        } catch (Exception e) {
            log.error("error", e);
