package com.jeequan.jeepay.pay.channel.rongfu2;
...
@Slf4j
@Service
public class Rongfu2ChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[容福2支付]";
