package com.jeequan.jeepay.pay.channel.diandian;
...
@Service
@Slf4j
public class DiandianPaymentService extends AbstractPaymentService {

    private static final String LOG_TAG = "[DD支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.DIANDIAN;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String pay_client_ip = payOrder.getClientIp();
            ...
            map.put("pay_client_ip", pay_client_ip);
    ...
    public static void main(String[] args) {
        ...
        String payGateway = "https://www.jingyun7000.top/Pay_Index.html";
