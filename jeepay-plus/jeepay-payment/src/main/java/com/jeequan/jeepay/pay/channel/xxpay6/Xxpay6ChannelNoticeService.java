package com.jeequan.jeepay.pay.channel.xxpay6;
...
@Slf4j
@Service
public class Xxpay6ChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[xxpay6支付]";
