package com.jeequan.jeepay.pay.channel.huoyan1;
...
@Slf4j
@Service
public class Huoyan1ChannelNoticeService extends AbstractChannelNoticeService {
    private static final String LOG_TAG = "[火焱1支付]";
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            //支付状态：3:交易成功,4:交易超时,5:交易失败,6:处理中
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("requestNo");        // 商户订单号
        ...
        if (resultsParam != null) {
            ...
            final String signContentStr = SignatureUtils.getSignContentFilterEmpty(map, new String[]{"attachData"}) + "&key=" + secret;
