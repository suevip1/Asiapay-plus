...
@Slf4j
@Service
public class Xiongmao2ChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        String txnAmt = jsonParams.getString("orderMoney");        // 支付金额
