...
@Slf4j
@Service
public class YifengChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("sh_order");        // 商户订单号
        ...
        if (resultsParam != null) {
            ...
            String signContent = SignatureUtils.getSignContentFilterEmpty(map, null) + secret;
