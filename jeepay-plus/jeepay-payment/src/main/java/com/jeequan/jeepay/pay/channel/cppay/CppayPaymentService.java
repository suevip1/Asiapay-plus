package com.jeequan.jeepay.pay.channel.cppay;
...
@Service
@Slf4j
public class CppayPaymentService extends AbstractPaymentService {

    private static final String LOG_TAG = "[CP支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.CPPAY;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String reqid = payOrder.getPayOrderId();

            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMddHHmmss");
            String reqts = dateFormat.format(new Date());

            String money = AmountUtil.convertCent2Dollar(payOrder.getAmount());
            String type = normalMchParams.getPayType();
            String cburl = getNotifyUrl(payOrder.getPayOrderId());
            String returl = cburl;
            ...
            String signStr = merid + reqid + reqts + type + money + returl + key;
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "bGhtYmxQem94c25o";

        String merid = "6029";
        String reqid = RandomStringUtils.random(15, true, true);

        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMddHHmmss");
        String reqts = dateFormat.format(new Date());

        String money = AmountUtil.convertCent2Dollar(1000L);
        String type = "30";
        String cburl = "https://www.test.com";
        String returl = cburl;
        ...
        String payGateway = "http://103.125.85.137:32686/gateway/cp.do";
