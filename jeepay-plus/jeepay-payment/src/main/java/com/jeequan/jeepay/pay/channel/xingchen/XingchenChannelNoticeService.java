...
@Slf4j
@Service
public class XingchenChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        ...
        if (resultsParam != null) {
            ...
            final String signContentStr = "mid=" + mid + "&status=" + status + "&id=" + id + "&orderid=" + orderid + "&orderamount=" + orderamount + "&" + secret;
