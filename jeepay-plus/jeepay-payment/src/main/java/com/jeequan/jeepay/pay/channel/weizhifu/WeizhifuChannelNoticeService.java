...
@Slf4j
@Service
public class WeizhifuChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public boolean verifyParams(JSONObject jsonParams, PayOrder payOrder, PayPassage payPassage) {
        String orderNo = jsonParams.getString("sdorderno");        // 商户订单号
        ...
        String sdpayno = jsonParams.getString("sdpayno");
        String sdorderno = jsonParams.getString("sdorderno");
        String total_fee = jsonParams.getString("total_fee");
        String paytype = jsonParams.getString("paytype");
        ...
        if (resultsParam != null) {
            ...
            String signContentStr = "customerid=" + customerid + "&status=" + status + "&sdpayno=" + sdpayno
                    + "&sdorderno=" + sdorderno + "&total_fee=" + total_fee+ "&paytype=" + paytype + "&" + secret;
