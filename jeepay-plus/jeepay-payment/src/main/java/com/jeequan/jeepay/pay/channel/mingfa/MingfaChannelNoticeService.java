...
@Slf4j
@Service
public class MingfaChannelNoticeService extends AbstractChannelNoticeService {
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            String outTradeNo = jsonParams.getString("outTradeNo");
            map.put("outTradeNo", outTradeNo);
            map.put("merchId", normalMchParams.getMchNo());
            ...
            //拉起订单成功
            if (queryResult.getString("code").equals("20000")) {
                JSONObject data = queryResult.getJSONObject("data");
                //订单状态： MI-正在匹配 MF-匹配失败 PI-正在支付 PS-支付成功
