package com.jeequan.jeepay.pay.channel.ruize;
...
@Slf4j
@Service
public class RuizeChannelNoticeService extends AbstractChannelNoticeService {
    private static final String LOG_TAG = "[瑞泽支付]";
    ...
    public ChannelRetMsg doNotice(HttpServletRequest request, Object params, PayOrder payOrder, PayPassage payPassage, NoticeTypeEnum noticeTypeEnum) {
        ...
        try {
            ...
            //订单状态：0=待⽀付，1=等待确认，2=已确认⽀付，3=超时，4=已冲正，5=交易失败
