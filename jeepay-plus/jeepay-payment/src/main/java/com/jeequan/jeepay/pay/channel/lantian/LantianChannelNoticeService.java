package com.jeequan.jeepay.pay.channel.lantian;
...
@Slf4j
@Service
public class LantianChannelNoticeService extends AbstractChannelNoticeService {

    private static final String LOG_TAG = "[蓝天支付]";
