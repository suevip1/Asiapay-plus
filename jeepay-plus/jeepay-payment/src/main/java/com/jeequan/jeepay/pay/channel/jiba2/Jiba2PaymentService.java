...
@Service
@Slf4j
public class Jiba2PaymentService extends AbstractPaymentService {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "17c28ebb5ad0404a3e98ab732e5c0976";

        String mchid = "PAY802a7_9000011";
        String mch_order_id = RandomStringUtils.random(15, true, true);
        String price = AmountUtil.convertCent2Dollar(1000L);
        String paytype = "2";
        ...
        map.put("sign", sign);
        String payGateway = "http://107.148.75.142/api/pay";
