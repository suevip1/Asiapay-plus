package com.jeequan.jeepay.pay.channel.gewasi;
...
@Service
@Slf4j
public class GewasiPaymentService extends AbstractPaymentService {
    private static final String LOG_TAG = "[格瓦斯支付]";

    @Override
    public String getIfCode() {
        return CS.IF_CODE.GEWASI;
    }
    ...
    public AbstractRS pay(UnifiedOrderRQ bizRQ, PayOrder payOrder, PayConfigContext payConfigContext) {
        ...
        try {
            ...
            String notifyUrl = getNotifyUrl(mchOrderId);
            ...
            String sign = SignatureUtils.md5(SignatureUtils.md5(JeepayKit.getSign(map, key).toLowerCase())).toLowerCase();
            map.put("sign", sign);
            ...
            if (result.getString("code").equals("0")) {
                ...
                String payUrl = data.getString("payInfo");
                String passageOrderId = data.getString("platformOrderId");
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> map = new HashMap<>();
        String key = "11a4a16a9a374c1ab8a4";
        ...
        String payGateway = "https://gwsapi.zd1688.top/export/tiga/api/order/create";
