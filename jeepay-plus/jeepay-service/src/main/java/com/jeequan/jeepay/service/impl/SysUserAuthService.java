...
public class SysUserAuthService extends ServiceImpl<SysUserAuthMapper, SysUserAuth> {
    ...
    /** 添加用户认证表 **/
    @Transactional
    public void addUserAuthDefault(Long userId, String loginUserName, String pwdRaw, String sysType){
    ...
    /** 重置密码 */
    @Transactional
    public void resetAuthInfo(Long resetUserId,String newPwd, String sysType){
