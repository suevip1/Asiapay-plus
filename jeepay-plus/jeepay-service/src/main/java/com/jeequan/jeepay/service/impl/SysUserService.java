...
//        if (StringUtils.isEmpty(roleIdListStr)) throw new BizException("请选择角色信息！");
//
...
//        if (roleIdList.isEmpty()) throw new BizException("请选择角色信息！");
        ...
        sysUserAuthService.addUserAuthDefault(sysUserId, sysUser.getLoginUsername(), authPwd, sysType);
     ...
     * @return
     */
    public Long findAgentAdminUserId(String mchNo) {
