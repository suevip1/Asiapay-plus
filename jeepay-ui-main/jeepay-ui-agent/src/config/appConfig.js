...
/** 应用配置项 **/
export default {
  APP_TITLE: '四方系统-代理系统', // 设置浏览器title
...
export const asyncRouteDefine = {
  ...
  'PassagePayOrderListPage': { defaultPath: '/passagePayOrder', component: () => import('@/views/order/pay/PassagePayOrderList.vue') }, // 通道订单列表
  ...
  'HistoryPage': { defaultPath: '/history', component: () => import('@/views/history/HistoryPage.vue') }, // 商户资金流水
  'DayStatList': { defaultPath: '/dayStat', component: () => import('@/views/dayStat/DayStatList.vue') }, // 商户日终统计
  'DivisionPage': { defaultPath: '/division', component: () => import('@/views/division/DivisionPage.vue') } // 结算管理
}
