...
import { API_URL_AGENT_DAY_STAT_LIST, req } from '@/api/manage'
import moment from 'moment'

// eslint-disable-next-line no-unused-vars
const tableColumns = [
  { key: 'date', title: '日期', width: '150px', fixed: 'left', scopedSlots: { customRender: 'dateSlot' } },
  { key: 'agentNo', title: '代理商号', dataIndex: 'agentNo', width: '150px', fixed: 'left' },
...
export default {
  ...
  methods: {
    ...
    reqTableDataFunc: (params) => {
      return req.list(API_URL_AGENT_DAY_STAT_LIST, params)
    },
