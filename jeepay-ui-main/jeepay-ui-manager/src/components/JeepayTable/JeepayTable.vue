...
export default {
  ...
  props: {
    ...
    pageSize: { type: Number, default: 20 }, // 默认每页条数
  ...
  data () {
    return {
      ...
      pagination: { total: 0, current: 1, pageSizeOptions: ['10', '20', '50', '100'], pageSize: this.pageSize, showSizeChanger: true, showTotal: total => `共${total}条` }, // ATable 分页配置项
      showLoading: false
    }
  },
  // 计算属性
