    ...
    <template>
      ...
      >
        <a-row justify="space-between" type="flex">
          ...
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="支付金额">
                <a-tag color="green">
                  {{ (detailData.payOrderAmount / 100).toFixed(2) }}
                </a-tag>
              </a-descriptions-item>
            </a-descriptions>
          </a-col>
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="手续费">
                <a-tag color="pink">{{ (detailData.mchRateAmount / 100).toFixed(2) }}</a-tag>
              </a-descriptions-item>
            </a-descriptions>
          </a-col>
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="业务类型">
                <a-tag color="blue" v-if="detailData.bizType === 1">支付</a-tag>
                <a-tag color="green" v-else-if="detailData.bizType === 2">提现</a-tag>
                <a-tag color="orange" v-else-if="detailData.bizType === 3">调账</a-tag>
              </a-descriptions-item>
            </a-descriptions>
          </a-col>
          <a-col :sm="12">
          ...
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="变更前余额">
                {{ (detailData.beforeBalance / 100).toFixed(2) }}
              </a-descriptions-item>
            </a-descriptions>
          </a-col>
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="变更后余额">
                {{ (detailData.afterBalance / 100).toFixed(2) }}
              </a-descriptions-item>
            </a-descriptions>
          </a-col>
          <a-col :sm="12">
          ...
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="代理商户名">
          ...
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="代理分润">
                <b>{{ (detailData.agentIncome / 100).toFixed(2) }}</b>
              </a-descriptions-item>
            </a-descriptions>
          </a-col>
          <a-divider/>
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="操作员ID">
                {{ detailData.createdUid }}
              </a-descriptions-item>
            </a-descriptions>
          </a-col>
          <a-col :sm="12">
            <a-descriptions>
              <a-descriptions-item label="操作员登录名">
                {{ detailData.createdLoginName }}
              </a-descriptions-item>
            </a-descriptions>
          </a-col>
        </a-row>
        ...
        <a-col :sm="12">
          <a-descriptions>
            <a-descriptions-item label="平台分润">
              <a-tag color="blue">
                {{ (detailData.platIncome / 100).toFixed(2) }}
              </a-tag>
            </a-descriptions-item>
          </a-descriptions>
        </a-col>
...
import { API_URL_MCH_HISTORY_LIST, req } from '@/api/manage'
...
const tableColumns = [
  ...
  { key: 'amount', width: '100px', title: '变更金额(￥)', scopedSlots: { customRender: 'amountSlot' } },
  {
    key: 'afterBalance',
    title: '变更后余额(￥)',
    width: '150px',
